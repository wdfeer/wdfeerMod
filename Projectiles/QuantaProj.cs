    ...
    internal class QuantaProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i1 = 0; i1 < Main.projectile.Length; i1++)
            {
                ...
                if (!p.active || p.type != Mod.Find<ModProjectile>("QuantaAltProj").Type || p.GetGlobalProjectile<Projectiles.wfGlobalProj>().exploding) continue;
        ...
        {
            SoundEngine.PlaySound(SoundID.DD2_LightningBugZap.WithVolume(0.15f));
        }
    }
}