            ...
            if (foundTarget)
            {
                ...
                else if (attackTimer <= 0)
                {
                    for (int i = 0; i < 6; i++)
                    {
                        ...
                        var proj = Main.projectile[Projectile.NewProjectile(projectile.Top, projVelocity + spread * Main.rand.NextFloat(-0.12f, 0.12f), ProjectileID.Bullet, projectile.damage, projectile.knockBack, projectile.owner)];
